(function() {
        ...
        // ---------- DATA ----------
        const timelineData = [
                { date: '2021', title: 'Enrolled at UNN Nsukka', desc: 'Began undergraduate studies in Computer Science.', detail: 'Courses in A.i, data analysis, and cyber security.' },
                { date: '2024', title: 'Discovered Web Development', desc: 'Fell in love with HTML & CSS.', detail: 'Started with basic landing pages and layouts.' },
                { date: '2025', title: 'Joined Digital Dreams Ltd', desc: 'First tech role at Digital Dreams Ltd in Enugu.', detail: 'Worked on some few HTML projects and learned Git.' },
                { date: 'March 2026', title: 'Mastered HTML, CSS Fundamentals', desc: 'Deep-dived into CSS styling.', detail: 'Built interactive website portfolio without frameworks.' },
                { date: 'Currently', title: 'Javascript Expansion', desc: 'Began exploring javascripts basics, String methods, Javascript, Function methods.', detail: 'Built REST APIs and connected frontend to backend.' },
                { date: '2026', title: 'Graduate Studies & Portfolio', desc: 'Continued at UNN while building projects.', detail: 'Focused on polished, production-ready work.' },
                { date: 'Currently', title: 'Emerging Frontend Developer', desc: 'Seeking impactful opportunities.', detail: 'Ready for challenging Frontend roles.' }
        ];
        ...
        renderTimeline();
        renderProjects();
        console.log('✅ Christian Nwodo portfolio ready – White & Blue theme.');
})();